                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', position: 'relative' }}>
                            ...
                            <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: '1rem', lineHeight: '1.5', color: 'rgba(255,255,255,0.7)' }}>Guests earn digital rewards and a personalised itinerary  - we seamlessly capture intent-based preferences specific to your location</p>
                                </div>
                            </div>
                             <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>

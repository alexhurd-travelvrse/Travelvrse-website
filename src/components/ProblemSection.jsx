                    ...
                    <div className="animate-fade-up delay-1 marketplace-header text-col" style={{ paddingTop: '0' }}>
                        <div style={{ marginBottom: '2rem' }}>
                            ...
                            <div style={{ fontSize: '1rem', fontWeight: 'bold', color: 'var(--color-gold)', letterSpacing: '1px', lineHeight: '1.5' }}>
                                We partner with creators to build interactive Vibe Challenges that target Next-Gen travellers—who search for experiences first. Driven by 100% real-time data
                            </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', position: 'relative' }}>
                            ...
                            <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: '1rem', lineHeight: '1.5', color: 'rgba(255,255,255,0.7)' }}>Travellers explore the top 5 vibing experiences in your area—both onsite and local. Try before you travel</p>
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
